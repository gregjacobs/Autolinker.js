// This file is responsible for generating the regular expression for matching
// alpha, numeric, emoji, and utf "mark" characters.
//
// We'll convert this RegExp to an efficient function to match the resulting
// character set in generate-char-utils.ts
