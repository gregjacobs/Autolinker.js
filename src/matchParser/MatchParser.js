...
Autolinker.matchParser.MatchParser = Autolinker.Util.extend( Object, {
	...
	matcherRegex : (function() {
		var twitterRegex = /(^|[^\w])@(\w{1,20})/,              // For matching a twitter handle. Ex: @gregory_jacobs
		    ...
		    domainNameRegex = /[A-Za-zА-Яа-яЁё0-9\.\-]*[A-Za-zА-Яа-яЁё0-9\-]/,  // anything looking at all like a domain, non-unicode domains, not ending in a period
		    ...
		    urlSuffixRegex = /[\-A-Za-zА-Яа-яЁё0-9+&@#\/%=~_()|'$*\[\]?!:,.;]*[\-A-Za-zА-Яа-яЁё0-9+&@#\/%=~_()|'$*\[\]]/;
