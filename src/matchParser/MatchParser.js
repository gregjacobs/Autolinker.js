...
Autolinker.matchParser.MatchParser = Autolinker.Util.extend( Object, {
	...
	var hashSigns = "[#＃]";
	var hashtagAlpha = "[" + unicodeLettersAndMarks + "]";
	var hashtagAlphaNumeric = "[" + unicodeLettersAndMarks + unicodeNumbers + hashtagSpecialChars + "]";
	var hashtagBoundary = "(?:^|$|[^&" + unicodeLettersAndMarks + unicodeNumbers + hashtagSpecialChars + "])";
	var validHashtag = new RegExp("(" + hashtagBoundary + ")" + hashSigns + "(?!\ufe0f|\u20e3)(" + hashtagAlphaNumeric + "*" + hashtagAlpha + hashtagAlphaNumeric + "*)");

	matcherRegex : (function() {
		var twitterRegex = /(^|[^\w])@(\w{1,15})/,              // For matching a twitter handle. Ex: @gregory_jacobs

		    hashtagRegex = validHashtag,             // For matching a Hashtag. Ex: #games
		    ...
		    domainNameRegex = /[A-Za-z0-9\u00C0-\u017F\.\-]*[A-Za-z0-9\u00C0-\u017F\-]/,  // anything looking at all like a domain, non-unicode domains, not ending in a period
