...
export class SchemeUrlMatcher extends UrlMatcher {
	...
	// 				urlMatchType          : 'scheme',
	// 				url                   : url,
	// 				protocolUrlMatch      : true,
	// 				protocolRelativeMatch : false,  // in this Matcher, we only match full schemes. Protocol-relative matches are handled by the TldUrlMatcher
...
enum State {
	...
	// Protocol-relative URL states
	//ProtocolRelativeSlash1,  -- put these here or in the TLD matcher?
...
class CurrentUrl {
	...
	//readonly isProtocolRelative: boolean;  // put this here or in the TLD matcher?
	...
	isValid() { 
		// Even though there could be valid schemes like my-scheme:do-something,
		// we don't want to link these as URLs as they would be likely be 
		// linking text that the user didn't actually want to link. Therefore, 
		// we standardize on the host part of the URL having at least one dot in
		// it, such as:
		//     my-scheme:google.com
