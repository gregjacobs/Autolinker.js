...
/*
 * The following regular expressions are for the characters that make up the 
 * following ABNF components.
 * 
...
export const uriUnreservedRe = new RegExp( `[${alphaNumericAndMarksCharsStr}\\-.+~]` );
export const uriGenDelimsRe = /[:\/?#\[\]@]/;
export const uriSubDelimsRe = /[!$&'()*+,;=]/;
