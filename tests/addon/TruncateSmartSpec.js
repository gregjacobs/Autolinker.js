...
describe("Truncate.addon.TruncateSmart", function(){
  ...
  it("Will remove malformed query section 1st", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 61, "..");
  ...
  it("Will remove 'www' 2nd", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 57, "..");
  ...
  it("Will remove scheme ('http') 3rd", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 53, "..");
  ...
  it("Will truncate fragment ('#') 4th", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 45, "..");
  ...
  it("Will truncate path ('/') 5th", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorezthis#baz=bee", 40, "..");
  ...
  it("Will keep fragment when there is room for it", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 50, "..");
    expect(truncatedUrl).toBe("yahoo.com/some/long/path/to/a/file?foo=bar#baz=bee");
    expect(truncatedUrl.length).toBe(50);
  });
  it("Will remove/truncate 'path' before 'host'", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 12, "..");
  ...
  it("Will truncate 'host' when 'truncateLen' is very short", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 7, "..");
    expect(truncatedUrl).toBe("yah..om");
    expect(truncatedUrl.length).toBe(7);
  });
  it("Will truncate 'path' when no 'query' exists", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file#baz=bee", 17, "..");
  ...
  it("Will truncate 'query' when no 'path' exists", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com?foo=bar?ignorethis#baz=bee", 17, "..");
    expect(truncatedUrl).toBe("yahoo.com?foo=bar");
    expect(truncatedUrl.length).toBe(17);
  });
  it("Works when no 'scheme' or 'host' exists", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 17, "..");
    expect(truncatedUrl).toBe("/some/lo..foo=bar");
    expect(truncatedUrl.length).toBe(17);
  });
  it("Works when only 'query' exists", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("?foo=bar?ignorethis#baz=bee", 15, "..");
    expect(truncatedUrl).toBe("?foo=bar#ba..ee");
    expect(truncatedUrl.length).toBe(15);
  });
  it("Works when only 'fragment' exists", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("#baz=bee", 5, "..");
    expect(truncatedUrl).toBe("#b..e");
    expect(truncatedUrl.length).toBe(5);
  });
  it("Works with a standard Google search URL", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("https://www.google.com/search?q=cake&oq=cake&aqs=chrome..69i57j69i60l5.573j0j7&sourceid=chrome&es_sm=93&ie=UTF-8", 80, "..");
  ...
  it("Works with a long URL", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("https://www.google.com/search?q=cake&safe=off&es_sm=93&tbas=0&tbs=qdr:d,itp:photo,ic:specific,isc:red,isz:l&tbm=isch&source=lnt&sa=X&ved=0CBQQpwVqFQoTCMCUxfOErMgCFeFrcgodUDwD1w&dpr=1&biw=1920&bih=955", 80, "..");
  ...
  it("Will start with a character from the URL and then append the ellipsis character(s)", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 3, "..");
  ...
  it("Will write only the ellipsis character(s) ('..') when truncate length is 2", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 2, "..");
  ...
  it("Will write only the ellipsis character ('.') when truncate length is 1", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 1, "..");
    expect(truncatedUrl).toBe(".");
    expect(truncatedUrl.length).toBe(1);
  });
  it("Will write nothing (empty string) when truncate length is 0", function(){
    var truncatedUrl = Autolinker.addon.TruncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 0, "..");
    expect(truncatedUrl).toBe("");
