import { ReverseUrlMatcher } from "../../src/matcher/reverse-url-matcher";
import { MatchChecker } from "../match/match-checker";
import { AnchorTagBuilder } from "../../src/anchor-tag-builder";

describe( "Autolinker.matcher.ReverseUrl", function() {
	let matcher: ReverseUrlMatcher;

	beforeEach( function() {
		matcher = new ReverseUrlMatcher( {
