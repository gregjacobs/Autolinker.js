...
describe("Truncate.truncate.truncateSmart", function() {
	...
	it("Will not truncate a URL which is shorter than the specified length", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 999, "..");
	...
	it("Will remove malformed query section 1st", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 61, "..");
	...
	it("Will remove 'www' 2nd", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 57, "..");
	...
	it("Will remove scheme ('http') 3rd", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 53, "..");
	...
	it("Will truncate fragment ('#') 4th", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 45, "..");
	...
	it("Will truncate path ('/') 5th", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorezthis#baz=bee", 40, "..");
	...
	it("Will keep fragment when there is room for it", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 50, "..");
		expect(truncatedUrl).toBe("yahoo.com/some/long/path/to/a/file?foo=bar#baz=bee");
		expect(truncatedUrl.length).toBe(50);
	});
	...
	it("Will remove/truncate 'path' before 'host'", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 12, "..");
	...
	it("Will truncate 'host' when 'truncateLen' is very short", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 7, "..");
	...
	it("Will truncate 'path' when no 'query' exists", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file#baz=bee", 17, "..");
	...
	it("Will truncate 'query' when no 'path' exists", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com?foo=bar?ignorethis#baz=bee", 17, "..");
	...
	it("Works when no 'scheme' or 'host' exists", function() {
		let truncatedUrl = truncateSmart("/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 17, "..");
	...
	it("Works with a standard Google search URL", function() {
		let truncatedUrl = truncateSmart("https://www.google.com/search?q=cake&oq=cake&aqs=chrome..69i57j69i60l5.573j0j7&sourceid=chrome&es_sm=93&ie=UTF-8", 80, "..");
	...
	it("Works with a long URL", function() {
		let truncatedUrl = truncateSmart("https://www.google.com/search?q=cake&safe=off&es_sm=93&tbas=0&tbs=qdr:d,itp:photo,ic:specific,isc:red,isz:l&tbm=isch&source=lnt&sa=X&ved=0CBQQpwVqFQoTCMCUxfOErMgCFeFrcgodUDwD1w&dpr=1&biw=1920&bih=955", 80, "..");
	...
	it("Will start with a character from the URL and then append the ellipsis character(s)", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 3, "..");
	...
	it("Will write only the ellipsis character(s) ('..') when truncate length is 2", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 2, "..");
	...
	it("Will write only the ellipsis character ('.') when truncate length is 1", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 1, "..");
		expect(truncatedUrl).toBe(".");
	...
	it("Will write nothing (empty string) when truncate length is 0", function() {
		let truncatedUrl = truncateSmart("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 0, "..");
		expect(truncatedUrl).toBe("");
